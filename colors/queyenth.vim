...
" Syntax Highlighting
" ----------------------------------------------------------------------------
hi Keyword              cterm=none ctermbg=none ctermfg=107          gui=none        guifg=#8EB33B
...
hi Constant             cterm=none ctermbg=none ctermfg=153          gui=none        guifg=#96D9F1
hi PreProc              cterm=none ctermbg=none ctermfg=107          gui=none        guifg=#CDEE69
hi Type                 cterm=none ctermbg=none ctermfg=74         gui=none        guifg=#96D9F1
hi Statement            cterm=none ctermbg=none ctermfg=107          gui=none        guifg=#D1FA71
hi Special              cterm=none ctermbg=none ctermfg=188           gui=none        guifg=#d7d7d7
hi String               cterm=none ctermbg=none ctermfg=179           gui=none        guifg=#F6DC69
hi Number               cterm=none ctermbg=none ctermfg=179           gui=none        guifg=#F6DC69
